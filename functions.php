<?php
    ...
    function result_pw($validations,$valid_name){
        if (isset($validations[$valid_name]) && $validations[$valid_name] == 'blank') {
            return 'パスワードを入力してください。';
        }elseif(isset($validations[$valid_name]) && $validations[$valid_name] == 'unmatch'){
            return 'パスワードは4~16文字の英数字で入力して下さい。';
        }
    }
